...
public abstract class BaseTranslucentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //标题栏的颜色
        translucentPrimaryColor = getResources().getColor(R.color.title_bar_color);
    ...
    public void setTranslucentPrimaryColor(int color){
        translucentPrimaryColor = color;
        mTitleBar.setBackgroundColor(translucentPrimaryColor);
    }
    ...
    public void setOrChangeTranslucentColor() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT
            ...
            if (mTitleBar != null) {
                //1.先设置toolbar的高度
                LayoutParams params = mTitleBar.getLayoutParams();
                ...
                mTitleBar.setPadding(
                        ...
                        mTitleBar.getPaddingTop() + getStatusBarHeight(this),
